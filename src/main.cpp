...
int main(int, char **)
{
  ...
  for (bool game_active = true; game_active;)
  {
    ...
    /*if ((game_map.tiles.at(new_player_pos.y + 0.5).at(new_player_pos.x + 0.5) ==
         '.') ||
        (game_map.tiles.at(new_player_pos.y + 0.5).at(new_player_pos.x + 0.5) ==
         '@'))*/

	if (new_player_pos.x + 0.5 > 0 && new_player_pos.x + 0.5 < game_map.tiles.at(0).size() && new_player_pos.y + 0.5 > 0 && new_player_pos.y + 0.5 < game_map.tiles.size())
	{    
		if (game_map.tiles.at(new_player_pos.y + 0.5).at(new_player_pos.x + 0.5) != '#')
		{
